export const Footer = () => {
    return (
        <footer className="bg-secudary-global-color dark:bg-gray-900">
            <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
                <div>
                    <h2 className="mb-6 text-md font-sans font-semibold text-white dark:text-white">Atendimento</h2>
                    <ul className="text-white dark:text-gray-400">
                        <li className="mb-4">
                            <a href="tel:8596869679" className=" hover:underline">Atendimento (85) 9 96869679</a>
                        </li>
                        <li className="mb-4">
                            <a href="#" className="hover:underline">Comercial (85) 9 96463164</a>
                        </li>
                        <li className="mb-4">
                            <a href="#" className="hover:underline">Fixo IBB (85) 31094521</a>
                        </li>
                        <li className="mb-4">
                            <a href="#" className="hover:underline">E-mail Comercial comercial@ibblife.com.br</a>
                        </li>
                        <li className="mb-4">
                            <a href="#" className="hover:underline">E-mail Atendimento atendimento@ibblife.com.br</a>
                        </li>
                        <li className="mb-4">
                            <a href="#" className="hover:underline">Fixo 24 horas SulAmerica 0800 726 49 35</a>
                        </li>
                    </ul>
                </div>
                <div>
            ...
            <div className="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
                <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
                    Boon Clube de Beneficios e Servico de Divulgacao Marketing Ltda © 2022.
                    Todos os direitos reservados. CNPJ: nº 34.104.415/0001-27
                    Av. Edilson Brasil Soares, 36
