...
export const SelectSocialCompanies = ({ value, onChange, disabled = false, id }: ISelectBanksProps) => {
    ...
    <>
      ...
      {!loading && (
        <select
          ...
          onChange={onChange}
          value={value}
          className={`isFocus px-3 py-3 text-base font-semibold text-secondary border rounded-[4px] w-full placeholder:text-secondary placeholder:text-base focus:outline-none focus:ring-2  'border-[#CED4DA] focus:ring-primary transition-colors`}
        >
